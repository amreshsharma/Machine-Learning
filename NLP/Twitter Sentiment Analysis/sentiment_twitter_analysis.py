...
# variety of words used in a feed.
def lexical_diversity(tokens):
    return 1.0 * len(set(tokens)) / len(tokens)

# function for computing number of words per tweet
...
def main():
    ...
    get_sentiment_analysis(cleaned_tweets)
